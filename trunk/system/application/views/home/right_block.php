							...
							<div id="sub_window_content" class="ardikam">
								...
								<div id="" style="width:98%;padding-top: 2px;" align="left" >
									<a href="<?=$link?><?=$details[0]->id?>/<?=$cat_id?>"><img style="float:left; margin:4px 20px 2px 4px; " src="<?=(isset($image_link)) ? $image_link : ''?>" id="img"></a>
										<a href="<?=$link?><?=$details[0]->id?>/<?=$cat_id?>" style="color:#228BEE; font-size:11px; text-decoration:none;outline-style: none;"><?=$details[0]->heading?></a>
												<div style="color:#000; font-size:12px" align="justify"><?=$details[0]->summary?></div>
												<div style="color:red; font-size:11px; margin-top:2px; line-height:8px" align="right">
										...
										<ul>
											...
											<li style="color:#228BEE;" >
												<a href="<?=$link?><?=$row->id?>/<?=$cat_id?>" style="color:#228BEE; font-size:11px; text-decoration:none;outline-style: none;"><?=$row->heading?></a>
											</li>
											<? if($count==3){
							         					break;
							          					}else{
