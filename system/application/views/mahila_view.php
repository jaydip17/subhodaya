        ...
        <td  valign="top">
	     <img src="<?=base_url();?>assets/imgs/sahithi1.jpg" width="680" height="96" />
	            ...
	            <div id="telugufont1">
	             ...
	             ?>
	              <a href="<?=base_url();?>mahila/mahiladetails/<?=$details_more['1']['0']->id?>"><img id="img"src="<?=base_url();?>assets/mahila/news_img<?=$details_more['1']['0']->id?>_thumb.jpg" style="float:left;padding:4px 20px 4px 4px;text-align: justify;"  align="top" border="0"  alt="gg"/></a>
	              <?} ?>
	            ...
	            <tr>
	             ...
	             ?>
	             	<a href="<?=base_url();?>mahila/mahiladetails/<?=$details_more['3']['0']->id?>"><img id="img" src="<?=base_url();?>assets/mahila/news_img<?=$details_more['3']['0']->id?>_thumb.jpg" style="float:left;padding:4px 20px 4px 4px;text-align: justify;" align="top" border="0"/></a>
	             <?}} ?>
	              <?if(!empty($details_more['3'])){?>
	            ...
	            <tr>
	             ...
	             ?>
	             	<a href="<?=base_url();?>mahila/mahiladetails/<?=$details_more['4']['0']->id?>"><img id="img" src="<?=base_url();?>assets/mahila/news_img<?=$details_more['4']['0']->id?>_thumb.jpg" style="float:left;padding:4px 20px 4px 4px;text-align: justify;" align="top" border="0"/></a>
	             <?}} ?>
	              <?if(!empty($details_more['3'])){?>
	            ...
	            <tr>
	             ...
	             ?>
	              <a href="<?=base_url();?>mahila/mahiladetails/<?=$details_more['5']['0']->id?>"><img id="img"src="<?=base_url();?>assets/mahila/news_img<?=$details_more['5']['0']->id?>_thumb.jpg" style="float:left;padding:4px 20px 4px 4px;text-align: justify;" align="top" border="0"/></a>
	              <?}} ?>
	              <?if(!empty($details_more['5'])){?>
	            ...
	            <tr>
	             ...
	             ?>
	              <a href="<?=base_url();?>mahila/mahiladetails/<?=$details_more['6']['0']->id?>"><img id="img" src="<?=base_url();?>assets/mahila/news_img<?=$details_more['6']['0']->id?>_thumb.jpg" style="float:left;padding:4px 20px 4px 4px;text-align: justify;" align="top" border="0"/></a>
	              <?}} ?>
                 <?if(!empty($details_more['6'])){?>
	            ...
	            <tr>
	             ...
	             ?>
	             	<a href="<?=base_url();?>mahila/mahiladetails/<?=$details_more['7']['0']->id?>"><img id="img" src="<?=base_url();?>assets/mahila/news_img<?=$details_more['7']['0']->id?>_thumb.jpg" style="float:left;padding:4px 20px 4px 4px;text-align: justify;" align="top" border="0"/></a>
	             <?}} ?>
	               <?if(!empty($details_more['7'])){?>
	            ...
	            <tr>
	             ...
	             ?>
	             	<a href="<?=base_url();?>mahila/mahiladetails/<?=$details_more['8']['0']->id?>"><img id="img"src="<?=base_url();?>assets/mahila/news_img<?=$details_more['8']['0']->id?>_thumb.jpg" style="float:left;padding:4px 20px 4px 4px;text-align: justify;" align="top" border="0"/></a>
	             <?}} ?>
	              <?if(!empty($details_more['8'])){?>
