...
echo form_open(base_url().'admin/mahila/delete');
 ?>
...
<tr>
		...
		<td width='50px'><a
			href="<?=base_url()?>admin/mahila/delete/<?=$item->id?>/<?=$cat_id ?>"
			onclick='return confirm("are you sure want to delete");'><img
			src="<?=base_url();?>assets/imgs/delete_on.gif" border='0' /></a></td>
		<td width='50px'><a href="<?=base_url()?>admin/mahila/edit/<?=$item->id?>"><img
