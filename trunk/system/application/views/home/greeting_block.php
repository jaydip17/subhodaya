...
<?php foreach ($details as $row):?>
	<div id="" style="float:left; width:110px;">
		<div id="" style="width:110px;height:70px;text-align:center;">
			<a href="<?=base_url()?>greetings/inner/<?=$row->id?>/<?=$row->type?>">
				<img src="<?=base_url()?>assets/greetings/gree_img<?=$row->id?>_thumb.jpg" border="0" style="border:1px solid #779AAC;width: 100px;height: 95px;">
			</a>
