          		...
          		<table width="100%" cellspacing="10" height="520px" >
          			<tr>
          				<td width="450" style="border: 1px solid #3789C3;"  valign="top">
          				 ...
          				 <span id="changeview">Change View:<button onclick="loadNews('<?=base_url()?>sahithilist/listview/<?=$row->cat_id?>')">get</button>
          				 <button onclick="loadNews('<?=base_url()?>sahithilist/thumbview/<?=$row->cat_id ?>')">get1</button></span>
          				 <? if($count==1){
          				 	break;
          				 }
          				 endforeach;	 
