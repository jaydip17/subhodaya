<div id="special_story">
							...
							<div id="sub_window_content">
								...
								<div id="story_title" style="color:#2571C4; font-size:11px"><?=$details['0']->heading?>
								</div>
								<div id="story" align="justify" style="line-height:20px; width:90%;font-size:10px">
									<?=$details['0']->summary?>
								</div>
								<div id="" align="right" style="font-size: 11px;">
