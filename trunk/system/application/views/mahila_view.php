        ...
        <td  valign="top">
	              ...
	              <?}} ?>
					...
					<td height="151px"koddiga
					 valign="top" colspan="3" style="background-image:url(<?=base_url();?>assets/imgs/KitchenTips-cr.gif);background-repeat-x;border: 1px solid #0A70BB;border-bottom: 0px;"><ul>
