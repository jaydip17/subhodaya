...
class Youtube {
	...
	function getYoutubeData()
	{
		...
		preg_match('|<media:description[^>]*>(.*?)</media:description>|is', $this->getFile_data(), $description);
...
//    $title = $doc->getElementsByTagName("title")->item(0)->nodeValue;	
	...
	$this->setEmbed_code('<object width="560" height="350" ><param name="movie" value="http://www.youtube.com/v/'.$this->getId().'&hl=en&fs=1&"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/'.$this->getId().'&hl=en&fs=1&" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="560" height="350"></embed></object>');
	return  $this->getEmbed_code();
	}
	function vEmbededCode($vid)
	{
	
	$this->setEmbed_code('<object width="560" height="350" ><param name="movie" value="http://www.youtube.com/v/'.$vid.'&hl=en&fs=1&"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/'.$vid.'&hl=en&fs=1&" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="560" height="350"></embed></object>');
	return  $this->getEmbed_code();
	}
	function getImage()
	{
		$this->setYu_image_url('http://img.youtube.com/vi/'.$this->getId().'/2.jpg');
		return "<img src='".$this->getYu_image_url()."' width='128' height='91' border='0' alt='".$this->getTitle()."' title='".$this->getTitle()."' />";
	}
