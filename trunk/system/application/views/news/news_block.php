<div style="height:248px;">
								...
								<a href="<?=$link?><?=$details[0]->id?>/<?=$details[0]->type?>"><img src="<?=(isset($image_link)) ? $image_link : ''?>" style="margin: 7px 20px 0px 0px;"/></a>
								<?php }?>
								<span id="headings"><a href="<?=$link?><?=$details[0]->id?>/<?=$details[0]->type?>"><?=(isset($details[0]->heading)) ? $details[0]->heading : ''?></a></span><br>
