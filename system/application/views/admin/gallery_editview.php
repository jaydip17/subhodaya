...
echo form_open(base_url().'admin/gallery/delete');
 ?>
...
<tr>
		...
		<img src="<?=base_url()?>assets/gallery/galle_img<?=$item->id?>_thumb.jpg" >
		<div><?=$item->name?></div>
		...
		<td width='50px'><a href="<?=base_url()?>admin/gallery/edit/<?=$item->id?>"><img
