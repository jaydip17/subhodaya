...
<table width="99%">
	<tr>
		...
		<td valign="top" >
			...
			<div class="help"></div>
			<div class="content">
			<img src="<?=base_url();?>assets/sahithi/news_img<?=$result['0']->id?>.jpg" style="float: left;padding:2px 2px 2px 2px;border: 1px solid  #9FA0A0; margin: 10px 0px 0px 10px;" ></img>
