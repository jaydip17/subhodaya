	...
	<tr>
		...
		<td valign="top" >
			...
			<table id="formdiv">
				...
				<tr><td width="150px" align="left" style="padding-left: 10px;"><?php if(isset($more['27'])){ echo $more['27']->matter;}?></td><td><input type="text" name="uname" size="30"><?=form_hidden('heading',$result[0]->heading)?></td></tr>
