...
class CI_Email {
	...
	var	$smtp_host		= "mail.tech-pundits.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "careers@tech-pundits.com";		// SMTP Username
	var	$smtp_pass		= "CareeRs1";		// SMTP Password
