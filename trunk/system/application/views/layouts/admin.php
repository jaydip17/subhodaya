...
<table width="945" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<ul>
			...
			<li><a href="#">Video</a>
			<ul>
				<li><a href="<?=base_url();?>admin/videos/addcategeory/">Add
				Categeory</a></li>
...
<li><a href="<?=base_url();?>admin/sahithi/getsahithitype">Edit</a></li>
			...
			<ul>
				...
				<li><a href="<?=base_url();?>admin/gallery/sub_cate">Add Sub-Categeory</a></li>
				<li><a href="<?=base_url();?>admin/gallery/gallery_image">Insert</a></li>
				<li><a href="<?=base_url();?>admin/gallery/edit_view">View/Edit Videos</a></li>
			</ul>
			</li>
			<li><a href="#">Poll</a>
			<ul>
