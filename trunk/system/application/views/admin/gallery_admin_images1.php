...
<?
echo form_open ( 'admin/gall/root_forimages' );
?>
...
<?
echo form_open_multipart( 'admin/gall/addImage' );
?>
...
?>
		...
		<td width="300">
<?=form_dropdown ( 'parentid1', $options );
?>
</td>
	</tr>
	<tr>
		<td>
<?=form_label ( 'Select title for image', 'title' );
?>
</td>
		<td>
<?
...
<tr>
<td>
<?=form_label ( 'Upload Zip File', 'image0' );
?>
</td>
		<td>
<?=form_upload('image0');?>
