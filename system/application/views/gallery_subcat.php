				...
				<div style="width:100%;float:left;">
					<div style="float:right; height:100%;"><img src="<?=base_url()?>assets/home_images/ads/mahila_ad1.jpg" width="243" height="194" />
					   ...
					   <div style="float:left;width:715px;"> 
					     <div  style="float:left;height:25px; width:700px; background-color:#EFE1E1; margin-top:5px; text-align:right; padding-top:4px; padding-right:5px;">Next>> Last>></div> 
					     <div  style="float:left;height:25px; width:700px; background-color:#EFE1E1; text-align:left; padding-top:4px; padding-left:6px; border-top:1px solid #999;"><?echo $paginate; ?></div>
						   ...
						   <div  style="float:left;height:25px; width:700px; background-color:#EFE1E1; text-align:right;padding-top:4px; padding-right:5px;margin-top:20px;">Next>> Last>></div>
